...
if ik==1
   Grid.K = 9.8692e-011.*ones(3,Grid.Nx,Grid.Ny,Grid.Nz);
elseif ik==2
   Grid.K = 9.8692e-012.*ones(3,Grid.Nx,Grid.Ny,Grid.Nz);
elseif ik==3
   Grid.K = 9.8692e-013.*ones(3,Grid.Nx,Grid.Ny,Grid.Nz);
elseif ik==4
   Grid.K = 9.8692e-014.*ones(3,Grid.Nx,Grid.Ny,Grid.Nz);
elseif ik==5
   Grid.K = 9.8692e-015.*ones(3,Grid.Nx,Grid.Ny,Grid.Nz);
else
   Grid.K = 9.8692e-016.*ones(3,Grid.Nx,Grid.Ny,Grid.Nz);
end                                 
